...
navigation = [Bunch(path = "Navigation/init.el",
              ...
              Bunch(path = "Navigation/buffer-rotate.el",
                    msg = "provides rotation between buffers"),
...
languages = [Bunch(path = "Languages/comments.el",
             ...
             Bunch(path = "Languages/Lisp/scratch-buffer.el",
                     msg = "prepare the scratch buffer"),
             ...
             Bunch(path = "Languages/Ruby/init.el",
                     msg = "init ruby mode"),
             Bunch(path = "Languages/Erlang/erlang-start.el",
