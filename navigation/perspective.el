...
named collections of buffers and window configurations."
  ...
  (if persp-mode
    ...
    (setq mode-line-position (delete '(:eval (persp-mode-line)) mode-line-position))
  ...
  (with-selected-frame frame
    ...
    (when persp-show-modestring
      (if (eq persp-show-modestring 'header)
        ...
        (setq mode-line-position (or mode-line-position '("")))
        (unless (member '(:eval (persp-mode-line)) mode-line-position)
          (setq mode-line-position (append mode-line-position '((:eval (persp-mode-line)))))))
      (persp-update-modestring))
...
(with-eval-after-load 'ibuffer
  ...
  (define-ibuffer-filter persp-name
    ...
    (when-let ((it (persp-ibuffer-name buf)))
