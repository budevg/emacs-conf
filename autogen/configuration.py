...
doc_lang = [Node(path = "doc_lang/init.el",
            ...
            Node(path = "doc_lang/org/init.el",
                 msg = "init org mode"),
...
prog_lang = [Node(path = "prog_lang/init.el",
             ...
             Node(path = "prog_lang/smart_code/eglot/init.el",
                  msg = "initialize eglot"),
             ...
             Node(path = "prog_lang/lua/lua-init.el",
                  msg = "init lua mode"),
             Node(path = "prog_lang/web/init.el",
                  msg = "init html/js mode"),
             ...
             Node(path = "prog_lang/elm/init.el",
                  msg = "init elm mode"),
...
applications = [Node(path = "applications/init.el",
                ...
                Node(path = "applications/elfeed/init.el",
                     msg = "Elfeed configration"),
